...
class AgendamentoCadastro extends StatefulWidget {
  final appointment;
  const AgendamentoCadastro({Key key, @required this.appointment})
      : super(key: key);
                              ...
                              body: Column(
                                ...
                                children: <Widget>[
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                        "Caso você tenha responda SIM no questionário, sua participação estará condicionada a apresentação de um atestado médico no dia do seu trajeto.",
                                        style: TextStyle(
                                            fontSize: 16.0,
                                            color: Colors.black),
...
class FormModel {
  ...
  FormModel({this.name, this.email, this.document, this.phone});
}
